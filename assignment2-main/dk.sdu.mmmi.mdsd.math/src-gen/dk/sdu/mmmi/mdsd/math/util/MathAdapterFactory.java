...
public class MathAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MathSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseOriginExp(OriginExp object)
      {
        return createOriginExpAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseLetend(Letend object)
      {
        return createLetendAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseLetMath(LetMath object)
      {
        return createLetMathAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.OriginExp <em>Origin Exp</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createOriginExpAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.Letend <em>Letend</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLetendAdapter()
  {
    return null;
  }
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.LetMath <em>Let Math</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createLetMathAdapter()
  {
    return null;
  }
